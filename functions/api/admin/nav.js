import { json, loadContact, loadNavData, loadSiteConfig, requestJson, requireSession, saveContact, saveNavData, saveSiteConfig } from "../../_utils.js";
...
export async function onRequestPut({ request, env }) {
  ...
  try {
    ...
    const site = Object.prototype.hasOwnProperty.call(payload || {}, "site")
      ? await saveSiteConfig(env.NAV_DB, payload.site)
      : await loadSiteConfig(env.NAV_DB);
    return json({ success: true, data, contact, site, message: "导航数据已保存" });
  } catch (error) {
