...
rem 项目: isoziyuan-nav (https://github.com/yys9253462-gif/isoziyuan-nav)
rem 域名: https://ailxw.com / https://isoziyuan-nav.pages.dev
rem =======================================================

setlocal enabledelayedexpansion
title Cloudflare Pages 一键发布工具

echo ===================================================
echo   Cloudflare Pages 一键全自动部署与发布系统
echo   目标项目: isoziyuan-nav (https://ailxw.com)
echo ===================================================
echo.
...
echo   恭喜！一键发布已成功完成！
echo.
echo   - 生产域名: https://ailxw.com
echo   - 备用域名: https://www.ailxw.com
echo   - Pages 域: https://isoziyuan-nav.pages.dev
echo   - 源码仓库: https://github.com/yys9253462-gif/isoziyuan-nav
echo ===================================================
echo.
